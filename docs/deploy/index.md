...
| --- | --- | --- | --- | --- |
| **APK 直装** | 闲置安卓手机、平板、电脑模拟器 (MuMu/雷电/AVD) | 开箱即用，无需 Linux 与内核配置经验 | 需要运行 Android 设备或常驻桌面模拟器；设备须支持 32 位应用（`armeabi-v7a`），纯 64 位机型见 [备选方案](/deploy/apk#无法安装-纯-64-位设备的备选方案) | 极简上手 |
